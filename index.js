...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_main_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./css/main.css */ \"./src/css/main.css\");\n/* harmony import */ var _ts_GameRunner_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ts/GameRunner.ts */ \"./src/ts/GameRunner.ts\");\n\n\nvar gameRoot = document.querySelector('.gameRoot');\n\nif (gameRoot !== null) {\n  var runner = new _ts_GameRunner_ts__WEBPACK_IMPORTED_MODULE_1__.GameRunner(gameRoot);\n  runner.start();\n} else {\n  var p = document.createElement('p');\n  p.innerText = 'Error load game script - root element not found';\n  document.body.append(p);\n}\n\n//# sourceURL=webpack://otus-ts-game-of-life/./src/index.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"GameRunner\": () => (/* binding */ GameRunner)\n/* harmony export */ });\n/* harmony import */ var _GamePresenter_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GamePresenter.ts */ \"./src/ts/GamePresenter.ts\");\n/* harmony import */ var _GameEngine_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GameEngine.ts */ \"./src/ts/GameEngine.ts\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\n // eslint-disable-next-line import/prefer-default-export\n\nvar GameRunner = function GameRunner(rootElement) {\n  _classCallCheck(this, GameRunner);\n\n  _defineProperty(this, \"start\", function () {});\n\n  var gameEngine = new _GameEngine_ts__WEBPACK_IMPORTED_MODULE_1__.GameEngine(undefined, 10, 10);\n  var gamePresenter = new _GamePresenter_ts__WEBPACK_IMPORTED_MODULE_0__.GamePresenter(rootElement, gameEngine);\n  gamePresenter.renderInitialPage();\n};\n\n//# sourceURL=webpack://otus-ts-game-of-life/./src/ts/GameRunner.ts?");
